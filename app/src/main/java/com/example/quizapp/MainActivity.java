    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioGroup1.getCheckedRadioButtonId() == R.id.q1_second_option)
                    scoreCount += 1;

                //question 2 answer
                RadioGroup radioGroup2 = findViewById(R.id.radioGroup2);
                if (radioGroup2.getCheckedRadioButtonId() == R.id.q2_fourth_option)
                    scoreCount += 1;
                ...
                if (q3CorrectAnswer.equals("January 04") ){
                    scoreCount += 1;}

                //question 4 answer
                RadioGroup radioGroup4 = findViewById(R.id.radioGroup4);
                if (radioGroup4.getCheckedRadioButtonId() == R.id.q4_first_option)
                    scoreCount += 1;

                //question 5 answer
                RadioGroup radioGroup5 = findViewById(R.id.radioGroup5);
                if (radioGroup5.getCheckedRadioButtonId() == R.id.q5_second_option)
                    scoreCount += 1;

                // getting question 6 input by user
                CheckBox earthCheckbox = findViewById(R.id.earth_checkbox);
                ...
                if(!americaCheckbox.isChecked() && earthCheckbox.isChecked() &&
                        plutoCheckbox.isChecked() &&
                        mercuryCheckbox.isChecked()){
                    scoreCount += 1;}

                //question 7 answer
                RadioGroup radioGroup7 = findViewById(R.id.radioGroup7);
                if (radioGroup7.getCheckedRadioButtonId() == R.id.q7_third_option)
                    scoreCount += 1;

                //question 8 answer
                RadioGroup radioGroup8 = findViewById(R.id.radioGroup8);
                if (radioGroup8.getCheckedRadioButtonId() == R.id.q8_fourth_option)
                    scoreCount += 1;

                //question 9 answer
                RadioGroup radioGroup9 = findViewById(R.id.radioGroup9);
                if (radioGroup9.getCheckedRadioButtonId() == R.id.q9_third_option)
                    scoreCount += 1;

                // question 10 answers
                RadioGroup radioGroup10 = findViewById(R.id.radioGroup10);
                if (radioGroup10.getCheckedRadioButtonId() == R.id.q10_second_option)
                   scoreCount += 1;

                Toast.makeText(MainActivity.this, "Name: " + studentName + "\nScore: " + scoreCount + "/10", Toast.LENGTH_LONG).show();
